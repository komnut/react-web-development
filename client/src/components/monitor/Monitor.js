...
class Monitor extends Component {
    ...
    addOrder(product) {
        ...
        this.setState({ totalPrice: totalPrice, orders: this.state.orders, confirm: false, msg: '' });
    }
    ...
    delOrder(product) {
        ...
        this.setState({ totalPrice: totalPrice, orders: resultOrder, confirm: false, msg: '' });
    }
    ...
    saveOrder() {
        ...
        if (totalPrice === 0) {
            this.setState({ confirm: true, msg: 'กรุณาเลือกรายการอาหาร' });
        }
        else {
